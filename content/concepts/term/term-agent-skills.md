...
**Agent Skills** 是为 AI agent（特别是 [Claude Code](../tool/tool-claude-code.md)、Pi、Codex、Cursor 等终端 / IDE 编码 agent）打包的**可复用提示词 + 工具调用模板**。一个 skill 通常包含：
...
- **可分发、可版本化**：一个 skill 就是一个仓库 / 一个目录，`git clone` 就能用，PR 就能贡献。代表：[mattpocock/skills](../tool/tool-mattpocock-skills.md)、[shadcn/improve](../tool/tool-shadcn-improve.md)。
...
- **生态三件套**：
  ...
  2. **代码审计 / 改进类** — [shadcn/improve](../tool/tool-shadcn-improve.md) 用最强模型审计仓库、出 backlog。
  3. **专用领域类** — [Hyperagent 设计网格 skill](../tool/tool-hyperagent-design-skill.md) 教代理做排版、[Archify](../tool/tool-archify.md) 把自然语言转成 SVG 架构图、[JSON-Render](../tool/tool-json-render.md) 让代理渲染真实 UI。
...
- [mattpocock/skills](../tool/tool-mattpocock-skills.md) — Real Engineers 风格的合集
- [shadcn/improve](../tool/tool-shadcn-improve.md) — 用最强模型做代码审计
- [Hyperagent 设计网格 skill](../tool/tool-hyperagent-design-skill.md) — Müller-Brockmann 网格教 AI 做设计
- [Archify](../tool/tool-archify.md) — 自然语言 → 架构图
- [JSON-Render / HarnessAgent](../tool/tool-json-render.md) — agent 沙盒里渲染真实 UI

## 相关概念

- [Claude Code](../tool/tool-claude-code.md)
- [mattpocock/skills](../tool/tool-mattpocock-skills.md)
- [shadcn/improve](../tool/tool-shadcn-improve.md)
