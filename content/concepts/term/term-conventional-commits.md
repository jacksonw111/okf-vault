...
[`playbook-monorepo-code-quality-setup`](../playbook/playbook-monorepo-code-quality-setup.md) 在 [Lefthook](../tool/tool-lefthook.md) 的 `commit-msg` 阶段用 `piped: true` + 正则强制：
...
- [Lefthook](../tool/tool-lefthook.md) —— 在 commit-msg 钩子强制执行
