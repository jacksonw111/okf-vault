...
- [Claude Code](concepts/tool-claude-code.md) — Recall 直接为其扩展的底层 agent
- [EverOS](concepts/tool-everos.md) — 同属「为 AI 代理提供统一长期记忆层」的赛道（EverOS 更通用，Recall 专攻 Claude Code）
- [Vercel Labs Personal AI Template](concepts/tool-vercel-personal-ai-template.md) — 另一种「持久化个人助手记忆」的实现路径