...
- [Agent Skills 是什么](../term/term-agent-skills.md) — a-stock-data 是「**垂直领域数据 skill**」的代表：把领域知识 + 接口封装打包，agent 即取即用。
- [Claude Code](../tool/tool-claude-code.md) — 首批支持的目标 agent 之一。
- [mattpocock/skills](../tool/tool-mattpocock-skills.md) — 同一波「skill 仓库」生态；mattpocock 偏通用 SOP，a-stock-data 偏垂直数据接口。

## 相关概念

- [Agent Skills 是什么](../term/term-agent-skills.md) — 垂直领域数据 skill 的典型实现
- [Claude Code](../tool/tool-claude-code.md) — a-stock-data 首批支持的目标 agent 之一
- [mattpocock/skills](../tool/tool-mattpocock-skills.md) — 同 skill 生态；通用 SOP vs 垂直数据接口的互补
