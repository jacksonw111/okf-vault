...
- [Agent Skills 是什么](../term/term-agent-skills.md) — ShipSwift 是「领域专用 skill」的代表，把 iOS SwiftUI 这个垂直领域做成可分发的能力包。
- [Claude Code](../tool/tool-claude-code.md) — Claude Code 是 ShipSwift 首批支持的目标 agent 之一。
- [mattpocock/skills](../tool/tool-mattpocock-skills.md) — 同一波「skill 仓库」生态；区别是 mattpocock 偏通用 SOP，ShipSwift 偏垂直领域代码库。

## 相关概念

- [Agent Skills 是什么](../term/term-agent-skills.md) — ShipSwift 是「领域专用 skill」的典型实现
- [Claude Code](../tool/tool-claude-code.md) — ShipSwift 通过 MCP 首批接入的目标 agent
- [mattpocock/skills](../tool/tool-mattpocock-skills.md) — 同一波 skill 生态；通用 SOP vs 垂直代码库的互补
