...
## 与 [index.how/to/articulate](../tool/tool-index-how-articulate.md) 的关系
...
| [index.how/to/articulate](../tool/tool-index-how-articulate.md) | **广义设计 / UI/UX** 12 大类词汇 |
...
- [index.how/to/articulate](../tool/tool-index-how-articulate.md) — 同一作者的大词典（12 类），animations.dev 是它的动画子卷
- [transitions.dev](../tool/tool-transitions-dev.md) — 词汇表管「怎么说」，transitions.dev 管「具体怎么实现」
- [textmotion.dev](../tool/tool-textmotion-dev.md) — 同一波「动效资源」生态；专注文本级动效
