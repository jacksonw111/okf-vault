...
让 LLM 用 HTML + Canvas / WebGL **程序化生成视频**（非传统视频生成模型），用 prompt 控制动画 / 形状 / 时间线。类似 [Archify](../tool/tool-archify.md) 的视频版。
...
- 与本知识库现有工具的呼应：
  - css-loaders ↔ [transitions.dev](../tool/tool-transitions-dev.md) / [textmotion.dev](../tool/tool-textmotion-dev.md)
  - 21st.dev ↔ [JSON-Render](../tool/tool-json-render.md) / [Hyperagent 设计网格](../tool/tool-hyperagent-design-skill.md)
  - Million ↔ [Turborepo](../tool/tool-turbo.md) 之外的「前端性能」单点
  - Alacritty ↔ 终端 / DevContainer 主题
  - open-design.ai ↔ [Archify](../tool/tool-archify.md)

## 相关概念

- [Archify](../tool/tool-archify.md)
- [JSON-Render / 生成式 UI](../tool/tool-json-render.md)
- [transitions.dev](../tool/tool-transitions-dev.md)
- [textmotion.dev](../tool/tool-textmotion-dev.md)
- [Hyperagent 设计网格 Skill](../tool/tool-hyperagent-design-skill.md)
- [Turborepo](../tool/tool-turbo.md)
