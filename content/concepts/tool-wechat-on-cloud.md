...
[`WechatOnCloud`](https://github.com/Gloridust/WechatOnCloud)（项目作者自称为「**云微**」）是一个开源项目：**把 Web 版微信 / X / Telegram / Instagram / 小红书等「支持浏览器登录」的社交媒体，装进一个 chromium 容器里**，让你在云端同时跑多个账号，再通过 PWA 通知机制让手机 / 桌面端都能收到推送。
