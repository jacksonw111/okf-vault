...
- [Biome](../tool/tool-biome.md) —— 主力格式化/Lint 引擎
- [Ultracite](../tool/tool-ultracite.md) —— Biome 的零配置预设
- [Lefthook](../tool/tool-lefthook.md) —— Git 钩子管理器
- [Turborepo](../tool/tool-turbo.md) —— 跨包任务编排
- [Conventional Commits](../term/term-conventional-commits.md) —— 提交信息规范
